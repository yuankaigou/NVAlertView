...
// ------------------------------------
@implementation NVAlertViewStyleKit
...
static UIImage *imageOfClose = nil;
...
+ (void)drawClose{
    ...
    //80 * 80
    // Color Declarations
    UIColor *color = [UIColor colorWithRed:239/255.0f green:239/255.0f blue:239/255.0f alpha:1.0];
    
    // Questionmark Shape Drawing
    UIBezierPath *closeIconPath = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(2, 2, 76, 76) cornerRadius:76/2.0];
    
    [closeIconPath setLineWidth:2.0f];
    [closeIconPath stroke];
    [color setStroke];
    [closeIconPath closePath];
    
    //两横线 36 - 12
    [closeIconPath moveToPoint:CGPointMake(30, 50)];
    [closeIconPath setLineWidth:2.0f];
    [closeIconPath addLineToPoint:CGPointMake(50, 30)];
    
    [closeIconPath setLineWidth:2.0f];
    [closeIconPath moveToPoint:CGPointMake(30, 30)];
    [closeIconPath addLineToPoint:CGPointMake(50, 50)];
    [closeIconPath stroke];
    [closeIconPath closePath];
...
+ (UIImage*)imageOfCheckmark
{
    ...
    [NVAlertViewStyleKit drawCheckmark];
...
+ (UIImage*)imageOfNotice
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [NVAlertViewStyleKit drawNotice];
...
+ (UIImage*)imageOfWarning
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [NVAlertViewStyleKit drawWarning];
...
+ (UIImage*)imageOfQuestion
{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [NVAlertViewStyleKit drawQuestion];
...
+ (UIImage *)imageOfClose{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(80, 80), NO, 0);
    [NVAlertViewStyleKit drawClose];
    imageOfClose = UIGraphicsGetImageFromCurrentImageContext();
    UIGraphicsEndImageContext();
